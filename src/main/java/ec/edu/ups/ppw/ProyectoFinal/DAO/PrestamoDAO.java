...
public class PrestamoDAO {
	...
	public void insert(Prestamo pre) {
		TypedQuery<Usuario> userQuery = em.createQuery("SELECT u FROM Usuario u WHERE u.usuario = :email",
				Usuario.class);
	...
	public long getCountReservasByLibro(String nombreLibro) {
		TypedQuery<Long> query = em.createQuery(
				"SELECT COUNT(p) FROM Prestamo p WHERE p.libro.nombre = :nombreLibro AND p.estado = 'Reservado'",
				Long.class);
